...
const AboutServices = () => {
    return (
        <div>
           <h1 className="md:text-4xl font-bold text-center text-blue-800 pt-12 pb-12 ">Reliable Services</h1>
...
<h1 className="text-xl font-bold text-blue-700 pt-3 text-center">Lens Implant Surgery</h1>
<p className="text-sm font-bold text-black pt-3 text-center">Dental implants are a popular and effective solution for replacing missing teeth. This surgical procedure involves placing titanium posts into the jawbone, acting as artificial tooth roots.</p>
</div>
</div>
<div>
...
<h1 className="text-xl font-bold text-blue-700 pt-3 text-center">Birth Control Implant</h1>
<p className="text-sm font-bold text-black pt-3 text-center">Dental implants are a popular and effective solution for replacing missing teeth. This surgical procedure involves placing titanium posts into the jawbone, acting as artificial tooth roots.</p>
</div>
</div>
            </div>
